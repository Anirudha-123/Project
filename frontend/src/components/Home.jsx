...
//       try {
//         const response = await fetch("https://project-backend-8ik1.onrender.com/api/products");
...
const Home = () => {
  ...
  return (
    <>
      {/* ✅ Bootstrap Carousel - Auto Slides */}
      <div className="lll car shop">
        <div
          id="heroCarousel"
          className="carousel slide mb-5"
        ...
        >
          ...
          <div className="carousel-inner hero-section lll">
            ...
            <div className="carousel-item ">
              ...
              />
              <div className="carousel-caption d-none d-md-block">
                <h2 className="fw-bold">📱💻⌚ Mobile, Laptop & Watch Sale!</h2>
            ...
            <div className="carousel-item">
              ...
              <div className="carousel-caption d-none d-md-block">
                <h2 className="fw-bold">📺 Smart TV Mega Sale!</h2>
                <p>Upgrade your entertainment experience with the latest Smart TVs.</p>
              </div>
            </div>
          </div>
              ...
              <div key={product._id} className="col-md-4">
                <div className="space">
                  <div className="product-card p-3 border rounded shadow-sm text-center">
                    ...
                    <h3 className="product-title">{product.name}</h3>
                    <p>{product.description}</p>
                    <h3 className="product-price text-success">{product.price} ₹</h3>
                    ...
                    {isAddedToCart(product._id) ? (
                      ...
                      <button className="place-order-btn mt-3" onClick={() => addToCart(product)}>
                        Add to Cart
                      </button>
                    )}
                  </div>
