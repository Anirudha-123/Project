...
const Login = () => {
  ...
  // Determine where to redirect: either the intended route or fallback
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://project-backend-8ik1.onrender.com/api/auth/login",
        {
          method: "POST",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
      ...
      // Redirect user back to intended page or fallback
