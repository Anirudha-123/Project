...
//   // Default values when the cart is empty
//   let totalMRP = 0;
//   let discount = 0;
//   let shippingFee = 0;
//   let finalTotal = 0;
...
//       0
//     );
//     discount = totalMRP > 500 ? totalMRP * 0.1 : 0; // 10% discount if MRP > 500
//     shippingFee = totalMRP > 1000 ? 0 : 50; // Free shipping if total > 1000
//     finalTotal = totalMRP - discount + shippingFee;
//   }
...
const Cart = () => {
  ...
  if (cartItems.length > 0) {
    ...
    discount = totalMRP > 500 ? totalMRP * 0.1 : 0;
    shippingFee = totalMRP > 1000 ? 0 : 50;
    finalTotal = totalMRP - discount + shippingFee;
  }
